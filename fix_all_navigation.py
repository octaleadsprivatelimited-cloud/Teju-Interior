#!/usr/bin/env python3
"""
Fix All Navigation Menus Script
This script updates all navigation menus to remove dead links and keep only the 9 required pages.
"""
...
def fix_navigation_in_file(filepath):
    """Fix navigation menu in a single HTML file"""
    try:
        with open(filepath, 'r', encoding='utf-8') as f:
            content = f.read()
        
        # Fix Home menu - remove submenu, keep only Home Page 4
        ...
        # Fix Projects menu - keep only Project 4 v2
        ...
        # Fix Services menu - keep only Services List
        ...
        # Fix Pages menu - keep only required pages
        ...
        # Fix Blog menu - keep only Blog 3 Column
...
def main():
    """Main function to fix all navigation menus"""
    ...
    print("=" * 60)
    print(f"📊 Navigation Fix Summary:")
